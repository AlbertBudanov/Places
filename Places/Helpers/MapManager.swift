...
//  Places
//
//  Created by Альберт on 18.02.2021.
//
...
//        постоянное отслеживание текущего местоположения пользователя
    ...
    func startTrackingUserLocation(for mapView: MKMapView, and location: CLLocation?,
